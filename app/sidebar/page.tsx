...
export function AppSidebar({ active, onChange, badges }: AppSidebarProps) {
  ...
  return (
    <>
      {/* DESKTOP / TABLETTE : sidebar verticale rétractable */}
      <aside
        className={`sticky top-[92px] hidden h-[calc(100vh-112px)] shrink-0 flex-col self-start rounded-[26px] border border-[#eadfd5] bg-white shadow-[0_8px_30px_rgba(83,46,32,.05)] transition-[width] duration-300 md:flex ${
